...
export const Hero = () => {
    return (
        <div>
            ...
            <div className="bg-gradient-to-t to-transparent from-black absolute z-10 w-[753px] h-[421px] bottom-9"></div>
            <div className="ps-5">
                <Button hover={"hover:bg-white hover:text-second"} bg={"bg-second w-[240px] text-white rounded-sm absolute bottom-32 left-5 z-20"} title={"Senin 03 Januari 2023"} />
            </div>
